...
function rainbow_parenthsis#Activate()
    highlight default level1c  ctermfg=brown        guibg=WhiteSmoke   guifg=RoyalBlue3
    highlight default level2c  ctermfg=Darkblue     guibg=WhiteSmoke   guifg=SeaGreen3
    highlight default level3c  ctermfg=darkgray     guibg=WhiteSmoke   guifg=DarkOrchid3
    highlight default level4c  ctermfg=darkgreen    guibg=WhiteSmoke   guifg=firebrick3
    highlight default level5c  ctermfg=cyan         guibg=AntiqueWhite guifg=RoyalBlue3
    highlight default level6c  ctermfg=darkred      guibg=AntiqueWhite guifg=SeaGreen3
    highlight default level7c  ctermfg=darkmagenta  guibg=AntiqueWhite guifg=DarkOrchid3
    highlight default level8c  ctermfg=brown        guibg=AntiqueWhite guifg=firebrick3
    highlight default level9c  ctermfg=gray         guibg=LemonChiffon guifg=RoyalBlue3
    highlight default level10c ctermfg=white        guibg=LemonChiffon guifg=SeaGreen3
    highlight default level11c ctermfg=darkmagenta  guibg=LemonChiffon guifg=DarkOrchid3
    highlight default level12c ctermfg=Darkblue     guibg=LemonChiffon guifg=firebrick3
    highlight default level13c ctermfg=darkgreen    guibg=AliceBlue    guifg=RoyalBlue3
    highlight default level14c ctermfg=cyan         guibg=AliceBlue    guifg=SeaGreen3
    highlight default level15c ctermfg=darkred      guibg=AliceBlue    guifg=DarkOrchid3
    highlight default level16c ctermfg=red          guibg=AliceBlue    guifg=firebrick3
    let b:rainbow_parenthesis_active = 1
endfunction
...
function rainbow_parenthsis#Clear()
    ...
    endwhile
    let b:rainbow_parenthesis_active = 0
endfunction

function rainbow_parenthsis#Toggle ()
    if ! exists('b:rainbow_parenthesis_active')
        call rainbow_parenthsis#LoadRound ()
    endif
    echo b:rainbow_parenthesis_active
    if b:rainbow_parenthesis_active != 0
