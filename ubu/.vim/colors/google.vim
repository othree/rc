...
" changelog:
"         0.2:	2008.11.27
"         		changed MatchParen to link to Type (thanks to Jaros艂aw M臋偶yk)
"         		added Diff*
"         0.1:	2008.11.20
"       		initial version
...
hi Constant 	guifg=#5583d3	guibg=#ffffff	gui=none
...
hi Identifier 	guifg=#557799	guibg=#ffffff	gui=none
...
hi StatusLine 	guifg=#ffffff	guibg=#3366dd	gui=bold
